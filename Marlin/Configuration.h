...
#define STRING_CONFIG_H_AUTHOR "(Kokorone, ELF BL-Touch Scaled modded for 5x TMC2209 in UART by mpalpha)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Elf BL-Touch"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //@ ELF stock
  #define DEFAULT_Kp 15.56
  #define DEFAULT_Ki 1.25
  #define DEFAULT_Kd 48.55
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 475 } // bondtech direct drive.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -20, -2.2 }
...
#define HOMING_FEEDRATE_Z  (50*120)
